...
const Loader = function(logger, configMain) {
  ...
  this.handleConfigs = function() {
    ...
    if (fs.existsSync(normalizedPath + 'vertcoin.js')) {
      config = require(normalizedPath + 'vertcoin.js');
    ...
    // No Configuration Created
      ...
      throw new Error('Unable to find vertcoin.js file. Read the installation/setup instructions');
    }
