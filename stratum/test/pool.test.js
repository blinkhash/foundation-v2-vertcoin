...
function mockClient() {
  ...
  client.id = 'test';
  client.addrPrimary = 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP';
...
describe('Test pool functionality', () => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:5888')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:5888')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool manager setup [8]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Submitted a primary block (Vertcoin:1) successfully to Vertcoin\'s daemon instance(s)');
  ...
  test('Test pool block polling setup [1]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[1][1]).toBe('Requested template from primary chain (Vertcoin:2) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool block polling setup [2]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 3) {
        ...
        expect(response[2][1]).toBe('Requested template from primary chain (Vertcoin:1) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool stratum setup [6]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
        expect(response[1][0]).toBe('log');
        expect(response[1][1]).toBe('Difficulty update queued for worker: VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP (8)');
        pool.network.stopNetwork();
      }
    });
    pool.on('client.socket.success', () => {
  ...
  test('Test pool stratum setup [7]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
        expect(response[1][0]).toBe('log');
        expect(response[1][1]).toBe('Difficulty updated successfully for worker: VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP (8)');
        pool.network.stopNetwork();
      }
    });
    pool.on('client.socket.success', () => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:5888')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP' }
        }));
      pool.checkWorker(pool.primary.daemon, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:5888')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP',
      worker: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP',
      worker: 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_primary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_primary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    worker2.miner = 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ';
    worker2.worker = 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ.worker4';
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_primary': { 'immature': 4999.998, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ_false_primary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_primary': { 'immature': 8474.10655446, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ_false_primary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_primary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_primary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [10]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_auxiliary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [11]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_auxiliary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.worker = 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ.worker4';
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_auxiliary': { 'immature': 4999.998, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ_false_auxiliary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [13]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_auxiliary': { 'immature': 8474.10655446, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ_false_auxiliary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_auxiliary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [15]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP_false_auxiliary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handleAuxiliaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
