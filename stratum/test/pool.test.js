...
describe('Test pool functionality', () => {
  ...
  test('Test pool manager setup [9]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        expect(text).toBe('Submitted a primary block (Vertcoin:1) successfully to Vertcoin\'s daemon instance(s)');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': 10000, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'generate': 0, 'immature': 20000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': 5000, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ': { 'immature': 5000, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': 8474.10994411, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ': { 'immature': 1525.89005589, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': 0, 'generate': 20000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': 9570.00569668, 'generate': 0 },
      'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjQ': { 'immature': 429.99430332, 'generate': 0 }};
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'VqspNKCc3ufsUSJb6Vq2TcEVX1Wn9EdHjP': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
