...
const Manager = function(config, configMain) {
  ...
  this.handleShare = function(
    ...
    const headerDigest = Algorithms.verthash.hash();
    ...
    const shareMultiplier = Algorithms.verthash.multiplier;
    const shareDiff = Algorithms.verthash.diff / Number(headerBigInt) * shareMultiplier;
    const blockDiffAdjusted = job.difficulty * Algorithms.verthash.multiplier;
